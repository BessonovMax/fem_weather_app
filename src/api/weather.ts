...
export async function fetchWeatherData(
  ...
  const API_URL = `https://api.open-meteo.com/v1/forecast?latitude=51.7727&longitude=55.0988&daily=weather_code,temperature_2m_max,temperature_2m_min&hourly=weather_code,temperature_2m&current=temperature_2m,relative_humidity_2m,apparent_temperature,weather_code,precipitation,wind_speed_10m${measurementUnit === "Metric" ? "" : "&wind_speed_unit=mph&temperature_unit=fahrenheit&precipitation_unit=inch"}`;
